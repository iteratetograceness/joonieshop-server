...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ai=sr,ei=cr,ti=$r,ni=Jr,ii=zr,oi=Qr,li=pr,fi=yr,ui=In,vi=xn,si=ri,ci=wr,$i=Pr,pi=2220446049250313e-31,yi=2148532223>>>0,E=[0,0],P=[0,0];function _i(r,a){var e,t;return r===0||li(r)||fi(r)?r:(vi(E),r=E[0],a+=E[1],a+=si(r),a<oi?ui(0,r):a>ni?r<0?ei:ai:(a<=ii?(a+=52,t=pi):t=1,ci(P),e=P[0],e&=yi,e|=a+ti<<20,t*$i(e,P[1])))}var bi=_i;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
